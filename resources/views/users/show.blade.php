...
<main>
    ...
    <div class="col-sm-6"> <button class="btn btn-primary"><i style="color: #fff;" class="fa fa-calendar-o"></i> Schedule</button></div>
    <div class="col-sm-6"> <button class="btn btn-primary"><i style="color: #fff;" class="fa fa-comments-o"></i> Message</button></div>
